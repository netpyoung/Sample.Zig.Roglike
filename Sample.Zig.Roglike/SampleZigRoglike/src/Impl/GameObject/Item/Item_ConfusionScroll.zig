...
const Item_ConfusionScroll = @This();
_amount: i32 = 10,

pub fn Activate(self: *const Item_ConfusionScroll, item: *const Item, game: *Game) void {
    var player = &game.player;
    const hp = player._status._hp;
    const nexthp = @max(hp + self._amount, player._status._hp_max);
